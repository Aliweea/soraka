export default ($scope,qService,kpiSpanRes) => {
 ...
 qService.httpGet(kpiSpanRes.spankpi,{'kpiID':8,'start':'2016-06-01','end':'2016-08-31'},{"X-Auth-Token":token}).then((data) => {
        console.log(data);
...
qService.httpGet(kpiSpanRes.spankpi,{'kpiID':8,'start':'2016-01-01','end':'2016-08-31'},{"X-Auth-Token":token}).then((data) => {
        console.log(data);
        $scope.kpiText = data.data.tag;
        $scope.yearchart={
     options: 
