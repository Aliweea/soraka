            ...
            var processFunction = function(data) {
                ...
                function initMapData(mapData) {
                    ...
                    function createInfoWindow(i) {
                        ...
                        var str = "<b class='iw_poi_title' title='" + json.title + "'>" + json.title + "</b><div class='iw_poi_content'>  <h5>本月发生刑事案件数:" + json.content + "起.其中:</h5> <div id='kpi' style='height: 250px; width: 75%;  margin: 0 auto'></div>" + "</div>";
                        var iw = new BMap.InfoWindow(str, { enableMessage: false });
                        return iw;
                    }
                    //创建一个Icon
                    function createIcon(json) {
                        var icon = new BMap.Icon("http://map.baidu.com/image/marker.png", new BMap.Size(json.w, json.h), { imageOffset: new BMap.Size(-json.l, -json.t), infoWindowOffset: new BMap.Size(json.lb + 5, 1), offset: new BMap.Size(json.x, json.h) })
                        return icon;
                    }
