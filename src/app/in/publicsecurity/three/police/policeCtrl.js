        ...
        var processFunction = function(data) {
            ...
            function wireEachMonthData(data) {
                for (var i = 0; i < data.length; i++) {
                    ...
                    eachMonthData[month - 1].value = eachMonthData[month - 1].value + data[i].beat + data[i].injury + data[i].blackmail + data[i].robPublic + data[i].steal + data[i].cheat + data[i].drug + data[i].gamble + data[i].whoredom + data[i].trouble + data[i].disturb + data[i].disturbCompa + data[i].gun + data[i].certificate + data[i].publicAsset + data[i].hinderDuty + data[i].elseCase;
                    if (month == $scope.getDate.month) {
                        ...
                        var amount = data[i].beat + data[i].injury + data[i].blackmail + data[i].robPublic + data[i].steal + data[i].cheat + data[i].drug + data[i].gamble + data[i].whoredom + data[i].trouble + data[i].disturb + data[i].disturbCompa + data[i].gun + data[i].certificate + data[i].publicAsset + data[i].hinderDuty + data[i].elseCase;
            ...
            $scope.pieChart = {
                options: {
                    ...
                    title: {
                        text: $scope.getDate.year + "年" + $scope.getDate.month + "月各类治安案件"
                    },
                    tooltip: {
            ...
            $scope.kpiBarChart = {
                options: {
                    ...
                    title: {
                        text: $scope.getDate.year + "年" + $scope.getDate.month + "月各派出所治安案件数"
                    },
                },
