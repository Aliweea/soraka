...
*******************************************************************************/
  function getCPIDataAll() {
    ...
    var CPIDATAPOST = qService.httpPostWithToken(dataDetailFactory.advancedQuery, {
      tableName: 'CPIData'
    }, {},queryMap)
  ...
  function getFoodPriceDataAll(year, month, day, dayList) {
    ...
    var SUBSIDIARYFOODPRICEDATA = qService.httpPostWithToken(dataDetailFactory.advancedQuery, {
...
*******************************************************************************/
  qService.httpPostWithToken(dataDetailFactory.lastestObject, {
        tableName: "CPIData"
      }, {},['year', 'month']).then(function(lastObjRaw){
  ...
  qService.httpPostWithToken(dataDetailFactory.lastestObject, {
        tableName: "SubsidiaryFoodPriceData"
      }, {},['year', 'month','day']).then(function(lastObjRaw){
    if (lastObjRaw.errorCode != "NO_ERROR") {
      $location.path("/main");
    }
    var latestObj = JSOG.parse(JSOG.stringify(lastObjRaw.data));
