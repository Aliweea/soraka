export default () => {
	...
	const handlePercentageUnit = (value, unit) => {
		return (value * 100).toFixed(1) + ' ' + UNIT_MAP[unit];
	}
	const handleNormalUnit = (value, unit) => {
		return value + ' ' + UNIT_MAP[unit];
	}
	const handleTTTUnit = (value, unit) => {
		return (value / 10000000).toFixed(1) + ' ' + UNIT_MAP[unit];
	}
	const handleMUnit = (value, unit) => {
		return (value / 1000000).toFixed(1) + ' ' + UNIT_MAP[unit];
	}
	const handleBUnit = (value, unit) => {
		return (value / 100000000).toFixed(1) + ' ' + UNIT_MAP[unit];
	}
	const handleTTUnit = (value, unit) => {
		return (value / 10000).toFixed(1) + ' ' + UNIT_MAP[unit];
	}
	const handleThousandPercetage = (value, unit) => {
